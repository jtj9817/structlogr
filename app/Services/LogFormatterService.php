...
class LogFormatterService
{
    public function format(string $rawLog, ?string $llmModel = null): array
    {
        ...
        $schema = $this->getSchemaForModel($llmModel);
...
PROMPT;
        ...
        match ($llmModel) {
            ...
            'gemini-2.5-flash' => $prismBuilder->using(Provider::Gemini, 'gemini-2.5-flash')
    ...
    private function getSchemaForModel(string $llmModel): ObjectSchema
    {
    ...
    private function getDefaultSchema(): ObjectSchema
    {
    ...
    private function getGeminiSchema(): ObjectSchema
    {
        return new ObjectSchema(
            'formatted_log',
            'Normalized representation of a parsed log with contextual sections',
